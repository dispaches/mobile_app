                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        fit: BoxFit.cover,
                        image: AssetImage("assets/images/screen_one.png"),
                      ),
                    ),
                  ),
                  Positioned(
                    ...
                    child: TextButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (builder) => ScreenTwo()),
                        );
                      },
                      child: Text(
                        "Skip",
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 10),
                    Text(
                      "Move goods faster with real-time tracking, escrow payments, and trusted drivers.",
                      textAlign: TextAlign.center,
                      style: TextStyle(
                        fontFamily: 'Poppins',
                        fontSize: 18,
